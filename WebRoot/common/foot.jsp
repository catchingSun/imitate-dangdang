...
<link href="<%=request.getContextPath()%>/css/public_footer.css" rel="stylesheet" type="text/css" />
	...
	<div class="public_footer_bottom">
		<div class="public_footer_icp" style="line-height: 48px;">
			...
			<a href="#" target="_blank"><img
					src="<%=request.getContextPath()%>/images/bottom/validate.gif" border="0" align="middle" /> </a>
